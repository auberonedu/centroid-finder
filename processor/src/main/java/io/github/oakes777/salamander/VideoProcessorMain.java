...
public class VideoProcessorMain {
    public static void main(String[] args) {
        if (args.length < 4) {
            System.out.println("Usage: java -jar salamander.jar <videoPath> <targetColorHex> <threshold> <outputCsvPath> [frameInterval]");
            return;
        }
        ...
        String intervalInput = (args.length >= 5) ? args[4] : "1";
        ...
        try {
            ...
            System.err.println("Error: Invalid number format for color, threshold, or frameInterval.");
            return;
