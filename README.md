# centroid-finder (Alston and Raymond)
...
"I, alstondsouza1, understand that AI is ONLY to be used for tests, and that every commit that I use AI for must start with 'AI Used'"
"I, RMarx1456, understand that AI is ONLY to be used for tests, and that every commit that I use for AI must start with 'AI Used'"
...
Video processing branch started...